...
public class ThursdayFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.thursday_fragment, container, false);
    ...
    public void onResume()
    {
    	...
    	TextView tv = (TextView) getActivity().findViewById(R.id.thursdayText);
    	
    	try 
    	{
			na = new NewNodeXmlParser(getActivity().getAssets().open("muhlenberg_dining.xml"), Calendar.THURSDAY);
			na.parse();
		} 
