...
public class SundayFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.sunday_fragment, container, false);
    ...
    public void onResume()
    {
    	...
    	TextView tv = (TextView) getActivity().findViewById(R.id.sundayText);
    	
    	try 
    	{
			na = new NewNodeXmlParser(getActivity().getAssets().open("muhlenberg_dining.xml"), Calendar.SUNDAY);
			na.parse();
		} 
