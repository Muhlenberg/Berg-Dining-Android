...
public class SaturdayFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.saturday_fragment, container, false);
    ...
    public void onResume()
    {
    	...
    	TextView tv = (TextView) getActivity().findViewById(R.id.saturdayText);
    	
    	try 
    	{
			na = new NewNodeXmlParser(getActivity().getAssets().open("muhlenberg_dining.xml"), Calendar.SATURDAY);
			na.parse();
		} 
